...
struct WeatherView: View {
    ...
    var body: some View {
        ZStack(alignment: .leading) {
            VStack {
                ...
                VStack {
                    HStack {
                        ...
                        Text(weather.main.feels_like.roundDouble() + "°").font(.system(size: 100))
                            .fontWeight(.bold)
                            .padding()
                    }
            ...
            }.padding().frame(maxWidth: .infinity, alignment: .leading).background(.black)
            ...
            VStack {
                ...
                }.frame(maxWidth: .infinity, alignment: .leading).padding().padding(.bottom, 20).foregroundColor(.black).background(.white).cornerRadius(20, corners: [.topLeft, .topRight])
